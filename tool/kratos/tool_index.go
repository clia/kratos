...
var toolIndexs = []*Tool{
	&Tool{
		...
		Install:   "go get -u github.com/clia/kratos/tool/kratos",
		Summary:   "Kratos工具集本体",
	...
	&Tool{
		...
		Alias:     "kratos-protoc",
		BuildTime: time.Date(2019, 6, 21, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/clia/kratos/tool/kratos-protoc",
	...
	&Tool{
		...
		BuildTime: time.Date(2019, 5, 5, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/clia/kratos/tool/kratos-gen-bts",
		Summary:   "缓存回源逻辑代码生成器",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "kratos",
	},
	&Tool{
		...
		Alias:     "kratos-gen-mc",
		BuildTime: time.Date(2019, 5, 5, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/clia/kratos/tool/kratos-gen-mc",
		Summary:   "mc缓存代码生成",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "kratos",
	},
